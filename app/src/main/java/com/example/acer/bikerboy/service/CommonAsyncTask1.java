package com.example.acer.bikerboy.service;
...
public class CommonAsyncTask1 extends AsyncTask<String, Void, SoapObject> {
    ...
    public CommonAsyncTask1(Context context, HashMap<String, String> properties) {
    ...
    protected SoapObject doInBackground(String... params) {
        ...
        if (CheckNetworkStatus.getInstance(context).isOnline()) {
            ...
            try {
                ...
                try {
                    soapResult = new HttpRequestService1().getRequestData(
